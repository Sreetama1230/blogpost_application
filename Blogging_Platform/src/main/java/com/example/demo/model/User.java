...
public class User implements Comparable<User> {
	...
	@JoinTable(name = "disliked_posts", joinColumns = @JoinColumn(name = "user_id"), inverseJoinColumns = @JoinColumn(name = "post_id"))

	private List<BlogPost> dislikedBlogPosts = new ArrayList<>();

	// this user follows those users
	@ManyToMany
	@JoinTable(name = "user_following", joinColumns = @JoinColumn(name = "follower_id"), // this user
	...
	@ManyToMany
	@JoinTable(name = "user_blocked_users", joinColumns = @JoinColumn(name = "blocker_id"), inverseJoinColumns = @JoinColumn(name = "blocked_id"))
